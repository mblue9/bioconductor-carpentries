...
trainees_yr2 <- tibble::tribble(
  ...
  "Hamdi Furkan Kepenek", "Abdullah Gül University", "Kayseri", "In Progress", 35.4867691, 38.731229,
  "陈秭如", "GuangZhou Lab", "Guangzhou", "In Progress", 113.264435, 23.129163,
...
gg <- ggplot() +
  ...
  "Certified" = 21,  # Circle
  "Certified - CZI Year 1" = 22,  # Square
  "Certified - CZI Year 2" = 24,  # Diamond
  "In Progress" = 21  # Circle
)) +
scale_size_manual(values = c(
  "Certified" = 1.5, 
  "Certified - CZI Year 1" = 1.5,  
  "Certified - CZI Year 2" = 1.5,  
  "In Progress" = 1.5
))
